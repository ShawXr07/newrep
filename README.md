...
Funcionalidades Implementadas
    ...
    API REST: Endpoints configurados en Node para consultar la base de datos.

    Seguridad: Validaciones de entrada de datos en formularios.

    Acceso Remoto: Configuración para permitir la visualización desde otros dispositivos en la red local.

Frontend
<img width="1313" height="723" alt="Captura desde 2026-05-20 11-51-43" src="https://github.com/user-attachments/assets/da029d2e-2dcb-499d-92f4-bfcacd4900a0" />


<img width="1313" height="723" alt="Captura desde 2026-05-20 11-55-26" src="https://github.com/user-attachments/assets/e9294d75-adad-4db2-95b2-6d47b2771e13" />
